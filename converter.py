...
st.sidebar.markdown("**Instant and precise unit conversions!**")
...
st.markdown("""
    <style>
        .stButton>button {
            background-color:rgb(233, 95, 251);
            color: white;
            font-size: 16px;
            border-radius: 10px;
            font-weight: bold;
        ...
        .stButton>button:hover {
            background-color:rgb(207, 64, 243);
        }
    </style>
""", unsafe_allow_html=True)

st.markdown("---")
st.markdown("<p style='text-align: center;'>🗺️ Made with 💟 by Rida Danish</p>", unsafe_allow_html=True)